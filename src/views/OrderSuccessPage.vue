  ...
  <div class="bg-surface text-on-surface">
    ...
    <main class="max-w-[1440px] mx-auto px-6 md:px-12 py-16">
      <section class="flex flex-col md:flex-row gap-16 items-start">
        <!-- Left Column: Message & Details - Full Width -->
        <div class="w-full">
          <div class="mb-12">
          ...
          <div class="bg-gray-50 dark:bg-gray-800 rounded-xl p-8 mb-8">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
              ...
              <div>
                ...
                <span class="font-bold text-primary italic">{{ expectedDelivery }}</span>
              </div>
              <div>
                <span class="block text-xs uppercase tracking-widest text-gray-400 mb-1">Shipping To</span>
                <span class="font-medium text-gray-800 dark:text-gray-200 leading-snug" v-html="shippingAddress"></span>
              </div>
              <div>
                <span class="block text-xs uppercase tracking-widest text-gray-400 mb-1">Payment Method</span>
                <span class="font-medium text-gray-800 dark:text-gray-200">{{ paymentMethod }}</span>
              </div>
            </div>
          </div>

          <div class="flex gap-4 flex-wrap">
            <button class="bg-gradient-to-r from-primary to-blue-700 text-white px-8 py-4 rounded-full text-sm uppercase tracking-widest hover:opacity-90 transition">
              Track Order Status
            </button>
            <button class="text-primary px-8 py-4 rounded-full text-sm uppercase tracking-widest hover:underline transition">
              Download Receipt
            </button>
            <router-link to="/" class="text-primary px-8 py-4 rounded-full text-sm uppercase tracking-widest hover:underline transition">
              Continue Shopping
            </router-link>
          </div>
        </div>
      ...
      <section class="mt-32">
        <div class="grid grid-cols-1 md:grid-cols-12 gap-8 items-stretch">
          ...
          <div class="md:col-span-4 bg-pink-50 dark:bg-pink-900/20 rounded-xl p-10 flex flex-col justify-center">
            ...
            <p class="text-gray-600 dark:text-gray-400 mb-8 text-sm leading-relaxed">Early access to boutique launches, private masterclasses, and curated beauty news.</p>
            <div class="flex border-b border-gray-300 dark:border-gray-600 pb-2">
              <input v-model="newsletterEmail" type="email" placeholder="Your email address" class="bg-transparent border-none focus:ring-0 text-sm w-full placeholder:text-gray-400 outline-none" />
